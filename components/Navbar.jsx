...
import { addTask } from "../utils/async"
  ...
  return (
    <div className="fixed before:h-24 w-screen flex flex-row align-middle border-2 rounded-sm bg-slate-100 shadow-xl">
      ...
      <div className="flex ml-auto mr-6 ">
        <button onClick={handleClick} className="bg-gray-200 hover:bg-sky-400 text-slate-700 hover:text-white my-auto py-3 px-3 rounded-md hover:rounded-xl rounded-3xl
